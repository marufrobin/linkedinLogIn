...
const String clientId = '861l72zhn2bhx2';
const String clientSecret = 'F63ZfcW78ra931vS';
...
class LinkedInAuthCodeExamplePage extends StatefulWidget {
  const LinkedInAuthCodeExamplePage();
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        LinkedInButtonStandardWidget(
          onTap: () {
            setState(() {
              authorizationCode = null as AuthCodeObject;
              logoutUser = true;
            });
          },
